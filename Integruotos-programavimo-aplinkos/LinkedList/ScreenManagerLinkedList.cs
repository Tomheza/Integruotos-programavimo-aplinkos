...
{
    class ScreenManagerLinkedList
    {
        public StudentsLinkedList studentsController = new StudentsLinkedList();
        public ScreenManagerLinkedList()
        {
            menu();
        }
        ...
        public void printMenu()
        {
            ...
            for (int i = 0; i < 59; i++)
                Console.Write("-");
            Console.WriteLine();
            Console.WriteLine("| {0, 29} {1, 29}", "Menu LinkedList<T> [" + Settings.version + "]", "|");
            Console.Write(" ");
            for (int i = 0; i < 59; i++)
                Console.Write("-");
            Console.WriteLine();
        ...
        public void addStudent()
        {
            try
            {
                ...
                for (int i = 2; i < stud_data.Length - 1; i++)
                    grades.AddLast(double.Parse(stud_data[i]));

                studentsController.AddStudent(new StudentLinkedList(name, surname, 0, exam, grades));
            }
            catch (Exception ex)
            {
        ...
        public static void GenerateSudentsIO(string filename, int count)
        {
            ...
            data.AddLast("Vardas    Pavarde    ND1    ND2    ND3    ND4    ND5    ND6    Egz.");
